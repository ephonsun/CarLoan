...
public class WorkerSearchController implements Initializable, IBoundary 
{
    @FXML
	...
	public CarLoanTO getData() {
		...
		searchData.put(WorkplaceParameters.CITY, txCittaSede.getText());
		searchData.put(WorkerParameters.TAX_CODE, txCodiceFiscale.getText());
